...
const EXPANDED_TOGGLES: { key: Extract<keyof StripConfigState, "showTokenUsage" | "showBackgroundTasks" | "showGitWorktrees">; label: string }[] = [
      ...
      <div className="settings-panel">
        ...
        {onOpenProjectManagement && (
          <div className="settings-panel__footer">
            <button
              type="button"
              className="settings-panel__projects-link"
